...
SELECT
    '5044a100-001f-4000-8000-00000000001f',
...
WHERE NOT EXISTS (SELECT 1 FROM __mj."Action" WHERE "ID" = '5044a100-001f-4000-8000-00000000001f');

INSERT INTO __mj."ActionParam" ("ID", "ActionID", "Name", "Type", "ValueType", "IsArray", "IsRequired", "Description")
SELECT
    '5044a100-001f-4000-8000-0000000000a1', '5044a100-001f-4000-8000-00000000001f',
...
WHERE NOT EXISTS (SELECT 1 FROM __mj."ActionParam" WHERE "ID" = '5044a100-001f-4000-8000-0000000000a1');

INSERT INTO __mj."ActionParam" ("ID", "ActionID", "Name", "Type", "ValueType", "IsArray", "IsRequired", "Description")
SELECT
    '5044a100-001f-4000-8000-0000000000a2', '5044a100-001f-4000-8000-00000000001f',
...
WHERE NOT EXISTS (SELECT 1 FROM __mj."ActionParam" WHERE "ID" = '5044a100-001f-4000-8000-0000000000a2');

INSERT INTO __mj."ActionResultCode" ("ID", "ActionID", "ResultCode", "IsSuccess", "Description")
SELECT '5044a100-001f-4000-8000-0000000000c1', '5044a100-001f-4000-8000-00000000001f', 'SUCCESS', true, 'Intervention run (or previewed) successfully.'
WHERE NOT EXISTS (SELECT 1 FROM __mj."ActionResultCode" WHERE "ID" = '5044a100-001f-4000-8000-0000000000c1');

INSERT INTO __mj."ActionResultCode" ("ID", "ActionID", "ResultCode", "IsSuccess", "Description")
SELECT '5044a100-001f-4000-8000-0000000000c2', '5044a100-001f-4000-8000-00000000001f', 'VALIDATION_ERROR', false, 'ConfigJSON missing or malformed.'
WHERE NOT EXISTS (SELECT 1 FROM __mj."ActionResultCode" WHERE "ID" = '5044a100-001f-4000-8000-0000000000c2');

INSERT INTO __mj."ActionResultCode" ("ID", "ActionID", "ResultCode", "IsSuccess", "Description")
SELECT '5044a100-001f-4000-8000-0000000000c3', '5044a100-001f-4000-8000-00000000001f', 'ERROR', false, 'The run failed (segment/intervention create or engine error).'
WHERE NOT EXISTS (SELECT 1 FROM __mj."ActionResultCode" WHERE "ID" = '5044a100-001f-4000-8000-0000000000c3');
