...
--
-- v1 wires the thin slice (segment → intervention → fire → record assignment); the measurement
-- tables (InterventionOutcome) and the holdout/lift math are created here but not yet engine-wired.
-- ActionPromotion (§5.5, the CodeSmith governance gate) is deferred to Phase 2 — action factors use
-- Factor.PromotionState directly today.
