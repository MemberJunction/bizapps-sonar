...
- **Engagement Manager:** a **Launch intervention** flow on the filtered triage cohort (in-context panel; preview is a hard gate before commit) and an **Interventions** tab tracking every launched play's treated/fired/held/failed tallies.
