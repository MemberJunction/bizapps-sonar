...
import { AssociationDemoCourseEntity } from '@mj-biz-apps/sonar-entities';
...
export class AssociationDemoCourseFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'pricingAndAvailability', sectionName: 'Pricing and Availability', isExpanded: true },
