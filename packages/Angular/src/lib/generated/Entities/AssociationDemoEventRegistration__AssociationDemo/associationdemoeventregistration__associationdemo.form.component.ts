...
export class AssociationDemoEventRegistration__AssociationDemoFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'registrationStatus', sectionName: 'Registration Status', isExpanded: true },
            { sectionKey: 'financialInformation', sectionName: 'Financial Information', isExpanded: true },
            { sectionKey: 'continuingEducation', sectionName: 'Continuing Education', isExpanded: true },
