...
import { AssociationDemoInvoiceLineItemEntity } from '@mj-biz-apps/sonar-entities';
...
export class AssociationDemoInvoiceLineItemFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'pricingAndCalculations', sectionName: 'Pricing and Calculations', isExpanded: true },
