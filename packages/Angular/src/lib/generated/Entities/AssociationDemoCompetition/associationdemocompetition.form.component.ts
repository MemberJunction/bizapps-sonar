...
import { AssociationDemoCompetitionEntity } from '@mj-biz-apps/sonar-entities';
...
export class AssociationDemoCompetitionFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'timelineAndDeadlines', sectionName: 'Timeline and Deadlines', isExpanded: true },
            { sectionKey: 'logisticsAndContact', sectionName: 'Logistics and Contact', isExpanded: true },
            { sectionKey: 'competitionMetrics', sectionName: 'Competition Metrics', isExpanded: true },
