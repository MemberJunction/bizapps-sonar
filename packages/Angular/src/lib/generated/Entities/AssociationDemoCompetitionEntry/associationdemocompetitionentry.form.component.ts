...
import { AssociationDemoCompetitionEntryEntity } from '@mj-biz-apps/sonar-entities';
...
export class AssociationDemoCompetitionEntryFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'judgingAndResults', sectionName: 'Judging and Results', isExpanded: true },
