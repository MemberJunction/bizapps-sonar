...
import { AssociationDemoSegmentEntity } from '@mj-biz-apps/sonar-entities';
...
export class AssociationDemoSegmentFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            { sectionKey: 'segmentDetails', sectionName: 'Segment Details', isExpanded: true },
            { sectionKey: 'configuration', sectionName: 'Configuration', isExpanded: true },
            { sectionKey: 'performanceAndMetrics', sectionName: 'Performance and Metrics', isExpanded: true },
