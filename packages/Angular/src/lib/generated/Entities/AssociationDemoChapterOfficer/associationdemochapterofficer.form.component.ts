...
import { AssociationDemoChapterOfficerEntity } from '@mj-biz-apps/sonar-entities';
...
export class AssociationDemoChapterOfficerFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            { sectionKey: 'officerAssignment', sectionName: 'Officer Assignment', isExpanded: true },
            { sectionKey: 'tenure', sectionName: 'Tenure', isExpanded: true },
