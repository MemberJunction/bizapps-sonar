...
import { AssociationDemoEventSessionEntity } from '@mj-biz-apps/sonar-entities';
...
export class AssociationDemoEventSessionFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'speakerAndAccreditation', sectionName: 'Speaker and Accreditation', isExpanded: true },
