...
export class AssociationDemoAccreditingBodyResolver extends ResolverBase {
    ...
    async AssociationDemoAccreditingBody(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoAccreditingBody_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwAccreditingBodies')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Accrediting Bodies', userPayload, EntityPermissionType.Read, 'AND');
    ...
    async AssociationDemoCertificationTypes_AccreditingBodyIDArray(@Root() associationdemoaccreditingbody_: AssociationDemoAccreditingBody_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCertificationTypes')} WHERE ${provider.QuoteIdentifier('AccreditingBodyID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Certification Types', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoaccreditingbody_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoAdvocacyActionResolver extends ResolverBase {
    ...
    async AssociationDemoAdvocacyAction(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoAdvocacyAction_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwAdvocacyActions')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Advocacy Actions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoBoardMemberResolver extends ResolverBase {
    ...
    async AssociationDemoBoardMember(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoBoardMember_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwBoardMembers')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Board Members', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoBoardPositionResolver extends ResolverBase {
    ...
    async AssociationDemoBoardPosition(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoBoardPosition_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwBoardPositions')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Board Positions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoBoardMembers_BoardPositionIDArray(@Root() associationdemoboardposition_: AssociationDemoBoardPosition_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Board Members', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwBoardMembers')} WHERE ${provider.QuoteIdentifier('BoardPositionID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Board Members', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoboardposition_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoCampaignMemberResolver extends ResolverBase {
    ...
    async AssociationDemoCampaignMember(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoCampaignMember_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCampaignMembers')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Campaign Members', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoCampaignResolver extends ResolverBase {
    ...
    async AssociationDemoCampaign(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoCampaign_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCampaigns')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Campaigns', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoEmailSends_CampaignIDArray(@Root() associationdemocampaign_: AssociationDemoCampaign_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEmailSends')} WHERE ${provider.QuoteIdentifier('CampaignID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Email Sends', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemocampaign_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoCampaignMembers_CampaignIDArray(@Root() associationdemocampaign_: AssociationDemoCampaign_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Campaign Members', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCampaignMembers')} WHERE ${provider.QuoteIdentifier('CampaignID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Campaign Members', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemocampaign_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoCertificateResolver extends ResolverBase {
    ...
    async AssociationDemoCertificate(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoCertificate_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCertificates')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Certificates', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoCertificationRenewalResolver extends ResolverBase {
    ...
    async AssociationDemoCertificationRenewal(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoCertificationRenewal_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCertificationRenewals')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Certification Renewals', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoCertificationRequirementResolver extends ResolverBase {
    ...
    async AssociationDemoCertificationRequirement(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoCertificationRequirement_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCertificationRequirements')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Certification Requirements', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoCertificationTypeResolver extends ResolverBase {
    ...
    async AssociationDemoCertificationType(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoCertificationType_ | null> {
        this.CheckUserReadPermissions('Certification Types', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCertificationTypes')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Certification Types', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoCertifications__AssociationDemo_CertificationTypeIDArray(@Root() associationdemocertificationtype_: AssociationDemoCertificationType_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCertifications__AssociationDemo')} WHERE ${provider.QuoteIdentifier('CertificationTypeID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Certifications__AssociationDemo', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemocertificationtype_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoCertificationRequirements_CertificationTypeIDArray(@Root() associationdemocertificationtype_: AssociationDemoCertificationType_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Certification Requirements', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCertificationRequirements')} WHERE ${provider.QuoteIdentifier('CertificationTypeID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Certification Requirements', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemocertificationtype_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class membershipCertificationResolver extends ResolverBase {
    ...
    async membershipCertification(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<membershipCertification_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('membership', 'vwCertifications')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Certifications', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoCertificationResolver extends ResolverBase {
    ...
    async AssociationDemoCertification(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoCertification_ | null> {
        this.CheckUserReadPermissions('Certifications__AssociationDemo', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCertifications__AssociationDemo')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Certifications__AssociationDemo', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoContinuingEducations_CertificationIDArray(@Root() associationdemocertification_: AssociationDemoCertification_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwContinuingEducations')} WHERE ${provider.QuoteIdentifier('CertificationID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Continuing Educations', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemocertification_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoCertificationRenewals_CertificationIDArray(@Root() associationdemocertification_: AssociationDemoCertification_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Certification Renewals', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCertificationRenewals')} WHERE ${provider.QuoteIdentifier('CertificationID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Certification Renewals', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemocertification_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoChapterMembershipResolver extends ResolverBase {
    ...
    async AssociationDemoChapterMembership(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoChapterMembership_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwChapterMemberships')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Chapter Memberships', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoChapterOfficerResolver extends ResolverBase {
    ...
    async AssociationDemoChapterOfficer(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoChapterOfficer_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwChapterOfficers')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Chapter Officers', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoChapterResolver extends ResolverBase {
    ...
    async AssociationDemoChapter(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoChapter_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwChapters')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Chapters', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoChapterMemberships_ChapterIDArray(@Root() associationdemochapter_: AssociationDemoChapter_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Chapter Memberships', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwChapterMemberships')} WHERE ${provider.QuoteIdentifier('ChapterID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Chapter Memberships', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemochapter_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoChapterOfficers_ChapterIDArray(@Root() associationdemochapter_: AssociationDemoChapter_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Chapter Officers', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwChapterOfficers')} WHERE ${provider.QuoteIdentifier('ChapterID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Chapter Officers', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemochapter_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoCommitteeMembershipResolver extends ResolverBase {
    ...
    async AssociationDemoCommitteeMembership(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoCommitteeMembership_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCommitteeMemberships')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Committee Memberships', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoCommitteeResolver extends ResolverBase {
    ...
    async AssociationDemoCommittee(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoCommittee_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCommittees')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Committees', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoCommitteeMemberships_CommitteeIDArray(@Root() associationdemocommittee_: AssociationDemoCommittee_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Committee Memberships', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCommitteeMemberships')} WHERE ${provider.QuoteIdentifier('CommitteeID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Committee Memberships', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemocommittee_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoCompetitionEntryResolver extends ResolverBase {
    ...
    async AssociationDemoCompetitionEntry(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoCompetitionEntry_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCompetitionEntries')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Competition Entries', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoProductAwards_CompetitionEntryIDArray(@Root() associationdemocompetitionentry_: AssociationDemoCompetitionEntry_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwProductAwards')} WHERE ${provider.QuoteIdentifier('CompetitionEntryID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Product Awards', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemocompetitionentry_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoCompetitionJudgeResolver extends ResolverBase {
    ...
    async AssociationDemoCompetitionJudge(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoCompetitionJudge_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCompetitionJudges')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Competition Judges', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoCompetitionResolver extends ResolverBase {
    ...
    async AssociationDemoCompetition(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoCompetition_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCompetitions')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Competitions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoCompetitionJudges_CompetitionIDArray(@Root() associationdemocompetition_: AssociationDemoCompetition_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Competition Judges', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCompetitionJudges')} WHERE ${provider.QuoteIdentifier('CompetitionID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Competition Judges', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemocompetition_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoProductAwards_CompetitionIDArray(@Root() associationdemocompetition_: AssociationDemoCompetition_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Product Awards', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwProductAwards')} WHERE ${provider.QuoteIdentifier('CompetitionID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Product Awards', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemocompetition_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Product Awards', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoCompetitionEntries_CompetitionIDArray(@Root() associationdemocompetition_: AssociationDemoCompetition_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Competition Entries', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCompetitionEntries')} WHERE ${provider.QuoteIdentifier('CompetitionID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Competition Entries', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemocompetition_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoContinuingEducationResolver extends ResolverBase {
    ...
    async AssociationDemoContinuingEducation(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoContinuingEducation_ | null> {
        this.CheckUserReadPermissions('Continuing Educations', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwContinuingEducations')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Continuing Educations', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoCourseResolver extends ResolverBase {
    ...
    async AssociationDemoCourse(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoCourse_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCourses')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Courses', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoEnrollments_CourseIDArray(@Root() associationdemocourse_: AssociationDemoCourse_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEnrollments')} WHERE ${provider.QuoteIdentifier('CourseID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Enrollments', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemocourse_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoCourses_PrerequisiteCourseIDArray(@Root() associationdemocourse_: AssociationDemoCourse_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Courses', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCourses')} WHERE ${provider.QuoteIdentifier('PrerequisiteCourseID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Courses', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemocourse_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoEmailClickResolver extends ResolverBase {
    ...
    async AssociationDemoEmailClick(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoEmailClick_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEmailClicks')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Email Clicks', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class membershipEmailEngagementResolver extends ResolverBase {
    ...
    async membershipEmailEngagement(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<membershipEmailEngagement_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('membership', 'vwEmailEngagements')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Email Engagements', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoEmailSendResolver extends ResolverBase {
    ...
    async AssociationDemoEmailSend(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoEmailSend_ | null> {
        this.CheckUserReadPermissions('Email Sends', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEmailSends')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Email Sends', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoEmailClicks_EmailSendIDArray(@Root() associationdemoemailsend_: AssociationDemoEmailSend_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Email Clicks', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEmailClicks')} WHERE ${provider.QuoteIdentifier('EmailSendID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Email Clicks', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoemailsend_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoEmailTemplateResolver extends ResolverBase {
    ...
    async AssociationDemoEmailTemplate(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoEmailTemplate_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEmailTemplates')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Email Templates', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoEmailSends_TemplateIDArray(@Root() associationdemoemailtemplate_: AssociationDemoEmailTemplate_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Email Sends', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEmailSends')} WHERE ${provider.QuoteIdentifier('TemplateID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Email Sends', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoemailtemplate_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Email Sends', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
...
export class AssociationDemoEnrollmentResolver extends ResolverBase {
    ...
    async AssociationDemoEnrollment(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoEnrollment_ | null> {
        this.CheckUserReadPermissions('Enrollments', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEnrollments')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Enrollments', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoCertificates_EnrollmentIDArray(@Root() associationdemoenrollment_: AssociationDemoEnrollment_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Certificates', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCertificates')} WHERE ${provider.QuoteIdentifier('EnrollmentID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Certificates', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoenrollment_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class membershipEventRegistrationResolver extends ResolverBase {
    ...
    async membershipEventRegistration(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<membershipEventRegistration_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('membership', 'vwEventRegistrations')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Event Registrations', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoEventRegistrationResolver extends ResolverBase {
    ...
    async AssociationDemoEventRegistration(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoEventRegistration_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEventRegistrations__AssociationDemo')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Event Registrations__AssociationDemo', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoEventSessionResolver extends ResolverBase {
    ...
    async AssociationDemoEventSession(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoEventSession_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEventSessions')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Event Sessions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoEventResolver extends ResolverBase {
    ...
    async AssociationDemoEvent(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoEvent_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEvents')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Events', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoEventRegistrations__AssociationDemo_EventIDArray(@Root() associationdemoevent_: AssociationDemoEvent_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Event Registrations__AssociationDemo', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEventRegistrations__AssociationDemo')} WHERE ${provider.QuoteIdentifier('EventID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Event Registrations__AssociationDemo', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoevent_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoEventSessions_EventIDArray(@Root() associationdemoevent_: AssociationDemoEvent_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Event Sessions', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEventSessions')} WHERE ${provider.QuoteIdentifier('EventID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Event Sessions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoevent_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoForumCategoryResolver extends ResolverBase {
    ...
    async AssociationDemoForumCategory(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoForumCategory_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumCategories')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Categories', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoForumThreads_CategoryIDArray(@Root() associationdemoforumcategory_: AssociationDemoForumCategory_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumThreads')} WHERE ${provider.QuoteIdentifier('CategoryID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Threads', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoforumcategory_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoForumCategories_ParentCategoryIDArray(@Root() associationdemoforumcategory_: AssociationDemoForumCategory_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Forum Categories', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumCategories')} WHERE ${provider.QuoteIdentifier('ParentCategoryID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Categories', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoforumcategory_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoForumModerationResolver extends ResolverBase {
    ...
    async AssociationDemoForumModeration(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoForumModeration_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumModerations')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Moderations', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoForumPostResolver extends ResolverBase {
    ...
    async AssociationDemoForumPost(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoForumPost_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumPosts')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Posts', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoPostTags_PostIDArray(@Root() associationdemoforumpost_: AssociationDemoForumPost_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwPostTags')} WHERE ${provider.QuoteIdentifier('PostID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Post Tags', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoforumpost_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoForumModerations_PostIDArray(@Root() associationdemoforumpost_: AssociationDemoForumPost_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Forum Moderations', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumModerations')} WHERE ${provider.QuoteIdentifier('PostID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Moderations', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoforumpost_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoPostAttachments_PostIDArray(@Root() associationdemoforumpost_: AssociationDemoForumPost_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwPostAttachments')} WHERE ${provider.QuoteIdentifier('PostID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Post Attachments', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoforumpost_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoPostReactions_PostIDArray(@Root() associationdemoforumpost_: AssociationDemoForumPost_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwPostReactions')} WHERE ${provider.QuoteIdentifier('PostID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Post Reactions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoforumpost_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoForumPosts_ParentPostIDArray(@Root() associationdemoforumpost_: AssociationDemoForumPost_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Forum Posts', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumPosts')} WHERE ${provider.QuoteIdentifier('ParentPostID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Posts', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoforumpost_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoForumThreadResolver extends ResolverBase {
    ...
    async AssociationDemoForumThread(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoForumThread_ | null> {
        this.CheckUserReadPermissions('Forum Threads', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumThreads')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Threads', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoForumPosts_ThreadIDArray(@Root() associationdemoforumthread_: AssociationDemoForumThread_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Forum Posts', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumPosts')} WHERE ${provider.QuoteIdentifier('ThreadID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Posts', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoforumthread_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Forum Posts', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
...
export class AssociationDemoGovernmentContactResolver extends ResolverBase {
    ...
    async AssociationDemoGovernmentContact(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoGovernmentContact_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwGovernmentContacts')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Government Contacts', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoAdvocacyActions_GovernmentContactIDArray(@Root() associationdemogovernmentcontact_: AssociationDemoGovernmentContact_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Advocacy Actions', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwAdvocacyActions')} WHERE ${provider.QuoteIdentifier('GovernmentContactID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Advocacy Actions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemogovernmentcontact_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoInvoiceLineItemResolver extends ResolverBase {
    ...
    async AssociationDemoInvoiceLineItem(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoInvoiceLineItem_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwInvoiceLineItems')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Invoice Line Items', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoInvoiceResolver extends ResolverBase {
    ...
    async AssociationDemoInvoice(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoInvoice_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwInvoices')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Invoices', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoPayments__AssociationDemo_InvoiceIDArray(@Root() associationdemoinvoice_: AssociationDemoInvoice_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwPayments__AssociationDemo')} WHERE ${provider.QuoteIdentifier('InvoiceID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Payments__AssociationDemo', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoinvoice_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoInvoiceLineItems_InvoiceIDArray(@Root() associationdemoinvoice_: AssociationDemoInvoice_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Invoice Line Items', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwInvoiceLineItems')} WHERE ${provider.QuoteIdentifier('InvoiceID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Invoice Line Items', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoinvoice_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoLegislativeBodyResolver extends ResolverBase {
    ...
    async AssociationDemoLegislativeBody(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoLegislativeBody_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwLegislativeBodies')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Legislative Bodies', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoGovernmentContacts_LegislativeBodyIDArray(@Root() associationdemolegislativebody_: AssociationDemoLegislativeBody_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Government Contacts', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwGovernmentContacts')} WHERE ${provider.QuoteIdentifier('LegislativeBodyID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Government Contacts', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemolegislativebody_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoLegislativeIssues_LegislativeBodyIDArray(@Root() associationdemolegislativebody_: AssociationDemoLegislativeBody_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwLegislativeIssues')} WHERE ${provider.QuoteIdentifier('LegislativeBodyID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Legislative Issues', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemolegislativebody_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoLegislativeIssueResolver extends ResolverBase {
    ...
    async AssociationDemoLegislativeIssue(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoLegislativeIssue_ | null> {
        this.CheckUserReadPermissions('Legislative Issues', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwLegislativeIssues')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Legislative Issues', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoPolicyPositions_LegislativeIssueIDArray(@Root() associationdemolegislativeissue_: AssociationDemoLegislativeIssue_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwPolicyPositions')} WHERE ${provider.QuoteIdentifier('LegislativeIssueID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Policy Positions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemolegislativeissue_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoAdvocacyActions_LegislativeIssueIDArray(@Root() associationdemolegislativeissue_: AssociationDemoLegislativeIssue_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Advocacy Actions', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwAdvocacyActions')} WHERE ${provider.QuoteIdentifier('LegislativeIssueID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Advocacy Actions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemolegislativeissue_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Advocacy Actions', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoRegulatoryComments_LegislativeIssueIDArray(@Root() associationdemolegislativeissue_: AssociationDemoLegislativeIssue_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwRegulatoryComments')} WHERE ${provider.QuoteIdentifier('LegislativeIssueID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Regulatory Comments', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemolegislativeissue_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoMemberFollowResolver extends ResolverBase {
    ...
    async AssociationDemoMemberFollow(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoMemberFollow_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwMemberFollows')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Member Follows', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class membershipMemberResolver extends ResolverBase {
    ...
    async membershipMember(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<membershipMember_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('membership', 'vwMembers')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Members', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoMemberResolver extends ResolverBase {
    ...
    async AssociationDemoMember(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoMember_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwMembers__AssociationDemo')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Members__AssociationDemo', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoResourceDownloads_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResourceDownloads')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resource Downloads', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoAdvocacyActions_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Advocacy Actions', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwAdvocacyActions')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Advocacy Actions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Advocacy Actions', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoChapterMemberships_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Chapter Memberships', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwChapterMemberships')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Chapter Memberships', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Chapter Memberships', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoMemberFollows_FollowerIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Member Follows', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwMemberFollows')} WHERE ${provider.QuoteIdentifier('FollowerID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Member Follows', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoInvoices_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Invoices', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwInvoices')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Invoices', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoChapterOfficers_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Chapter Officers', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwChapterOfficers')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Chapter Officers', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Chapter Officers', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoCampaignMembers_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Campaign Members', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCampaignMembers')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Campaign Members', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Campaign Members', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoMemberships_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwMemberships')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Memberships', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoForumThreads_LastReplyAuthorIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Forum Threads', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumThreads')} WHERE ${provider.QuoteIdentifier('LastReplyAuthorID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Threads', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Forum Threads', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoForumThreads_AuthorIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Forum Threads', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumThreads')} WHERE ${provider.QuoteIdentifier('AuthorID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Threads', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Forum Threads', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoEventRegistrations__AssociationDemo_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Event Registrations__AssociationDemo', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEventRegistrations__AssociationDemo')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Event Registrations__AssociationDemo', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Event Registrations__AssociationDemo', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoEnrollments_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Enrollments', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEnrollments')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Enrollments', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Enrollments', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoEmailSends_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Email Sends', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwEmailSends')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Email Sends', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Email Sends', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoCommitteeMemberships_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Committee Memberships', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCommitteeMemberships')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Committee Memberships', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Committee Memberships', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoForumCategories_LastPostAuthorIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Forum Categories', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumCategories')} WHERE ${provider.QuoteIdentifier('LastPostAuthorID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Categories', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Forum Categories', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoCompetitionJudges_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Competition Judges', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCompetitionJudges')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Competition Judges', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Competition Judges', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoBoardMembers_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Board Members', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwBoardMembers')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Board Members', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Board Members', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoForumModerations_ModeratedByIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Forum Moderations', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumModerations')} WHERE ${provider.QuoteIdentifier('ModeratedByID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Moderations', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Forum Moderations', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoForumModerations_ReportedByIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Forum Moderations', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumModerations')} WHERE ${provider.QuoteIdentifier('ReportedByID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Moderations', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Forum Moderations', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoResources_AuthorIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResources')} WHERE ${provider.QuoteIdentifier('AuthorID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resources', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoResourceRatings_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResourceRatings')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resource Ratings', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoPostAttachments_UploadedByIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Post Attachments', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwPostAttachments')} WHERE ${provider.QuoteIdentifier('UploadedByID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Post Attachments', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Post Attachments', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoContinuingEducations_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Continuing Educations', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwContinuingEducations')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Continuing Educations', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Continuing Educations', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoCommittees_ChairMemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Committees', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCommittees')} WHERE ${provider.QuoteIdentifier('ChairMemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Committees', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoPostReactions_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Post Reactions', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwPostReactions')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Post Reactions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Post Reactions', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoCertifications__AssociationDemo_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Certifications__AssociationDemo', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCertifications__AssociationDemo')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Certifications__AssociationDemo', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Certifications__AssociationDemo', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoProducts_MemberIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwProducts')} WHERE ${provider.QuoteIdentifier('MemberID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Products', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoForumPosts_EditedByIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Forum Posts', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumPosts')} WHERE ${provider.QuoteIdentifier('EditedByID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Posts', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Forum Posts', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoForumPosts_AuthorIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Forum Posts', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwForumPosts')} WHERE ${provider.QuoteIdentifier('AuthorID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Forum Posts', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Forum Posts', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoResourceVersions_CreatedByIDArray(@Root() associationdemomember_: AssociationDemoMember_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResourceVersions')} WHERE ${provider.QuoteIdentifier('CreatedByID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resource Versions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomember_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoMembershipTypeResolver extends ResolverBase {
    ...
    async AssociationDemoMembershipType(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoMembershipType_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwMembershipTypes')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Membership Types', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoMemberships_MembershipTypeIDArray(@Root() associationdemomembershiptype_: AssociationDemoMembershipType_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Memberships', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwMemberships')} WHERE ${provider.QuoteIdentifier('MembershipTypeID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Memberships', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemomembershiptype_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Memberships', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
...
export class AssociationDemoMembershipResolver extends ResolverBase {
    ...
    async AssociationDemoMembership(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoMembership_ | null> {
        this.CheckUserReadPermissions('Memberships', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwMemberships')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Memberships', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
//****************************************************************************
// ENTITY CLASS for MJ_BizApps_Sonar: Intervention Proposals
//****************************************************************************
@ObjectType({ description: `A concrete per-member action a play prepared for human review (e.g. a drafted outreach email) — proposal type + payload are data, so new play types need no schema change.` })
export class mjBizAppsSonarInterventionProposal_ {
    @Field() 
    @MaxLength(36)
    ID: string;
    ...
    @Field({description: `Canonical id of the anchor record this proposal is for (matches Score.AnchorRecordID).`}) 
    @MaxLength(450)
    AnchorRecordID: string;
        
    @Field({nullable: true, description: `Display name of the member at draft time (denormalized so the review queue never re-resolves anchors).`}) 
    @MaxLength(300)
    AnchorName?: string;
        
    @Field({description: `What kind of action is proposed (e.g. EmailDraft). Determines how PayloadJSON is shaped and rendered; an open set — new plays add new types.`}) 
    @MaxLength(30)
    ProposalType: string;
        
    @Field({nullable: true, description: `One-line human-readable reason this member got this proposal (shown on the review queue card).`}) 
    @MaxLength(1000)
    Rationale?: string;
        
    @Field({nullable: true, description: `The proposal content, shaped per ProposalType (EmailDraft: {subject, body, recipientEmail}).`}) 
    PayloadJSON?: string;
        
    @Field({nullable: true, description: `The score facts the proposal was grounded in ({score, bandName, delta, dominantCause, factors[]}) — the audit trail for "why this member".`}) 
    GroundingJSON?: string;
        
    @Field({description: `Review lifecycle: Proposed (awaiting review), Approved, Rejected, or Executed (carried out — for the PoC, a simulated send).`}) 
    @MaxLength(16)
    Status: string;
        
    @Field({nullable: true, description: `When a human approved or rejected the proposal.`}) 
    ReviewedAt?: Date;
        
    @Field({nullable: true, description: `When the approved proposal was executed (PoC: the simulated send).`}) 
    ExecutedAt?: Date;
...
//****************************************************************************
// INPUT TYPE for MJ_BizApps_Sonar: Intervention Proposals
//****************************************************************************
@InputType()
export class CreatemjBizAppsSonarInterventionProposalInput {
    @Field({ nullable: true })
    ID?: string;
...
//****************************************************************************
@InputType()
export class UpdatemjBizAppsSonarInterventionProposalInput {
    @Field()
    ID: string;
...
//****************************************************************************
// RESOLVER for MJ_BizApps_Sonar: Intervention Proposals
//****************************************************************************
@ObjectType()
export class RunmjBizAppsSonarInterventionProposalViewResult {
    @Field(() => [mjBizAppsSonarInterventionProposal_])
    Results: mjBizAppsSonarInterventionProposal_[];
...
@Resolver(mjBizAppsSonarInterventionProposal_)
export class mjBizAppsSonarInterventionProposalResolver extends ResolverBase {
    @Query(() => RunmjBizAppsSonarInterventionProposalViewResult)
    async RunmjBizAppsSonarInterventionProposalViewByID(@Arg('input', () => RunViewByIDInput) input: RunViewByIDInput, @Ctx() { providers, userPayload }: AppContext, @PubSub() pubSub: PubSubEngine) {
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        return super.RunViewByIDGeneric(input, provider, userPayload, pubSub);
    }

    @Query(() => RunmjBizAppsSonarInterventionProposalViewResult)
    async RunmjBizAppsSonarInterventionProposalViewByName(@Arg('input', () => RunViewByNameInput) input: RunViewByNameInput, @Ctx() { providers, userPayload }: AppContext, @PubSub() pubSub: PubSubEngine) {
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        return super.RunViewByNameGeneric(input, provider, userPayload, pubSub);
    }

    @Query(() => RunmjBizAppsSonarInterventionProposalViewResult)
    async RunmjBizAppsSonarInterventionProposalDynamicView(@Arg('input', () => RunDynamicViewInput) input: RunDynamicViewInput, @Ctx() { providers, userPayload }: AppContext, @PubSub() pubSub: PubSubEngine) {
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        input.EntityName = 'MJ_BizApps_Sonar: Intervention Proposals';
        return super.RunDynamicViewGeneric(input, provider, userPayload, pubSub);
    }
    @Query(() => mjBizAppsSonarInterventionProposal_, { nullable: true })
    async mjBizAppsSonarInterventionProposal(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<mjBizAppsSonarInterventionProposal_ | null> {
        this.CheckUserReadPermissions('MJ_BizApps_Sonar: Intervention Proposals', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('__mj_BizAppsSonar', 'vwInterventionProposals')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'MJ_BizApps_Sonar: Intervention Proposals', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.MapFieldNamesToCodeNames('MJ_BizApps_Sonar: Intervention Proposals', rows && rows.length > 0 ? rows[0] : null, this.GetUserFromPayload(userPayload));
        return result;
    }
    
    @Mutation(() => mjBizAppsSonarInterventionProposal_)
    async CreatemjBizAppsSonarInterventionProposal(
        @Arg('input', () => CreatemjBizAppsSonarInterventionProposalInput) input: CreatemjBizAppsSonarInterventionProposalInput,
        @Ctx() { providers, userPayload }: AppContext,
        @PubSub() pubSub: PubSubEngine
    ) {
        const provider = GetReadWriteProvider(providers);
        return this.CreateRecord('MJ_BizApps_Sonar: Intervention Proposals', input, provider, userPayload, pubSub)
    }
        
    @Mutation(() => mjBizAppsSonarInterventionProposal_)
    async UpdatemjBizAppsSonarInterventionProposal(
        @Arg('input', () => UpdatemjBizAppsSonarInterventionProposalInput) input: UpdatemjBizAppsSonarInterventionProposalInput,
        @Ctx() { providers, userPayload }: AppContext,
        @PubSub() pubSub: PubSubEngine
    ) {
        const provider = GetReadWriteProvider(providers);
        return this.UpdateRecord('MJ_BizApps_Sonar: Intervention Proposals', input, provider, userPayload, pubSub);
    }
    
    @Mutation(() => mjBizAppsSonarInterventionProposal_)
    async DeletemjBizAppsSonarInterventionProposal(@Arg('ID', () => String) ID: string, @Arg('options___', () => DeleteOptionsInput) options: DeleteOptionsInput, @Ctx() { providers, userPayload }: AppContext, @PubSub() pubSub: PubSubEngine) {
        const provider = GetReadWriteProvider(providers);
        const key = new CompositeKey([{FieldName: 'ID', Value: ID}]);
        return this.DeleteRecord('MJ_BizApps_Sonar: Intervention Proposals', key, options, provider, userPayload, pubSub);
    }
...
export class mjBizAppsSonarIntervention_ {
    ...
    @Field(() => [mjBizAppsSonarInterventionProposal_])
    mjBizAppsSonarMJ_BizApps_Sonar_InterventionProposals_InterventionIDArray: mjBizAppsSonarInterventionProposal_[]; // Link to mjBizAppsSonarMJ_BizApps_Sonar_InterventionProposals
...
export class mjBizAppsSonarInterventionResolver extends ResolverBase {
    ...
    @FieldResolver(() => [mjBizAppsSonarInterventionProposal_])
    async mjBizAppsSonarMJ_BizApps_Sonar_InterventionProposals_InterventionIDArray(@Root() mjbizappssonarintervention_: mjBizAppsSonarIntervention_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('MJ_BizApps_Sonar: Intervention Proposals', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('__mj_BizAppsSonar', 'vwInterventionProposals')} WHERE ${provider.QuoteIdentifier('InterventionID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'MJ_BizApps_Sonar: Intervention Proposals', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [mjbizappssonarintervention_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('MJ_BizApps_Sonar: Intervention Proposals', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
...
export class AssociationDemoOrganizationResolver extends ResolverBase {
    ...
    async AssociationDemoOrganization(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoOrganization_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwOrganizations')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Organizations', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoMembers__AssociationDemo_OrganizationIDArray(@Root() associationdemoorganization_: AssociationDemoOrganization_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Members__AssociationDemo', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwMembers__AssociationDemo')} WHERE ${provider.QuoteIdentifier('OrganizationID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Members__AssociationDemo', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoorganization_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class membershipPaymentResolver extends ResolverBase {
    ...
    async membershipPayment(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<membershipPayment_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('membership', 'vwPayments')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Payments', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoPaymentResolver extends ResolverBase {
    ...
    async AssociationDemoPayment(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoPayment_ | null> {
        this.CheckUserReadPermissions('Payments__AssociationDemo', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwPayments__AssociationDemo')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Payments__AssociationDemo', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoPolicyPositionResolver extends ResolverBase {
    ...
    async AssociationDemoPolicyPosition(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoPolicyPosition_ | null> {
        this.CheckUserReadPermissions('Policy Positions', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwPolicyPositions')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Policy Positions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoPostAttachmentResolver extends ResolverBase {
    ...
    async AssociationDemoPostAttachment(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoPostAttachment_ | null> {
        this.CheckUserReadPermissions('Post Attachments', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwPostAttachments')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Post Attachments', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoPostReactionResolver extends ResolverBase {
    ...
    async AssociationDemoPostReaction(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoPostReaction_ | null> {
        this.CheckUserReadPermissions('Post Reactions', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwPostReactions')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Post Reactions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoPostTagResolver extends ResolverBase {
    ...
    async AssociationDemoPostTag(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoPostTag_ | null> {
        this.CheckUserReadPermissions('Post Tags', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwPostTags')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Post Tags', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoProductAwardResolver extends ResolverBase {
    ...
    async AssociationDemoProductAward(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoProductAward_ | null> {
        this.CheckUserReadPermissions('Product Awards', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwProductAwards')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Product Awards', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoProductCategoryResolver extends ResolverBase {
    ...
    async AssociationDemoProductCategory(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoProductCategory_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwProductCategories')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Product Categories', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoProductCategories_ParentCategoryIDArray(@Root() associationdemoproductcategory_: AssociationDemoProductCategory_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Product Categories', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwProductCategories')} WHERE ${provider.QuoteIdentifier('ParentCategoryID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Product Categories', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoproductcategory_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoProducts_CategoryIDArray(@Root() associationdemoproductcategory_: AssociationDemoProductCategory_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Products', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwProducts')} WHERE ${provider.QuoteIdentifier('CategoryID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Products', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoproductcategory_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Products', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoCompetitionEntries_CategoryIDArray(@Root() associationdemoproductcategory_: AssociationDemoProductCategory_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Competition Entries', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCompetitionEntries')} WHERE ${provider.QuoteIdentifier('CategoryID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Competition Entries', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoproductcategory_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Competition Entries', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
...
export class AssociationDemoProductResolver extends ResolverBase {
    ...
    async AssociationDemoProduct(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoProduct_ | null> {
        this.CheckUserReadPermissions('Products', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwProducts')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Products', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoCompetitionEntries_ProductIDArray(@Root() associationdemoproduct_: AssociationDemoProduct_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Competition Entries', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCompetitionEntries')} WHERE ${provider.QuoteIdentifier('ProductID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Competition Entries', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoproduct_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Competition Entries', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoProductAwards_ProductIDArray(@Root() associationdemoproduct_: AssociationDemoProduct_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Product Awards', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwProductAwards')} WHERE ${provider.QuoteIdentifier('ProductID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Product Awards', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoproduct_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Product Awards', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
...
export class AssociationDemoRegulatoryCommentResolver extends ResolverBase {
    ...
    async AssociationDemoRegulatoryComment(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoRegulatoryComment_ | null> {
        this.CheckUserReadPermissions('Regulatory Comments', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwRegulatoryComments')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Regulatory Comments', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoResourceCategoryResolver extends ResolverBase {
    ...
    async AssociationDemoResourceCategory(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoResourceCategory_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResourceCategories')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resource Categories', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoResources_CategoryIDArray(@Root() associationdemoresourcecategory_: AssociationDemoResourceCategory_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Resources', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResources')} WHERE ${provider.QuoteIdentifier('CategoryID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resources', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoresourcecategory_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Resources', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoResourceCategories_ParentCategoryIDArray(@Root() associationdemoresourcecategory_: AssociationDemoResourceCategory_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Resource Categories', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResourceCategories')} WHERE ${provider.QuoteIdentifier('ParentCategoryID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resource Categories', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoresourcecategory_.ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoResourceDownloadResolver extends ResolverBase {
    ...
    async AssociationDemoResourceDownload(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoResourceDownload_ | null> {
        this.CheckUserReadPermissions('Resource Downloads', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResourceDownloads')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resource Downloads', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoResourceRatingResolver extends ResolverBase {
    ...
    async AssociationDemoResourceRating(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoResourceRating_ | null> {
        this.CheckUserReadPermissions('Resource Ratings', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResourceRatings')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resource Ratings', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
//****************************************************************************
// ENTITY CLASS for Resource Reviews
//****************************************************************************
@ObjectType()
export class membershipResourceReview_ {
    @Field() 
    @MaxLength(36)
    ID: string;
...
//****************************************************************************
// INPUT TYPE for Resource Reviews
//****************************************************************************
@InputType()
export class CreatemembershipResourceReviewInput {
    @Field({ nullable: true })
    ID?: string;
...
//****************************************************************************
@InputType()
export class UpdatemembershipResourceReviewInput {
    @Field()
    ID: string;
...
//****************************************************************************
// RESOLVER for Resource Reviews
//****************************************************************************
@ObjectType()
export class RunmembershipResourceReviewViewResult {
    @Field(() => [membershipResourceReview_])
    Results: membershipResourceReview_[];
...
@Resolver(membershipResourceReview_)
export class membershipResourceReviewResolver extends ResolverBase {
    @Query(() => RunmembershipResourceReviewViewResult)
    async RunmembershipResourceReviewViewByID(@Arg('input', () => RunViewByIDInput) input: RunViewByIDInput, @Ctx() { providers, userPayload }: AppContext, @PubSub() pubSub: PubSubEngine) {
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        return super.RunViewByIDGeneric(input, provider, userPayload, pubSub);
    }

    @Query(() => RunmembershipResourceReviewViewResult)
    async RunmembershipResourceReviewViewByName(@Arg('input', () => RunViewByNameInput) input: RunViewByNameInput, @Ctx() { providers, userPayload }: AppContext, @PubSub() pubSub: PubSubEngine) {
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        return super.RunViewByNameGeneric(input, provider, userPayload, pubSub);
    }

    @Query(() => RunmembershipResourceReviewViewResult)
    async RunmembershipResourceReviewDynamicView(@Arg('input', () => RunDynamicViewInput) input: RunDynamicViewInput, @Ctx() { providers, userPayload }: AppContext, @PubSub() pubSub: PubSubEngine) {
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        input.EntityName = 'Resource Reviews';
        return super.RunDynamicViewGeneric(input, provider, userPayload, pubSub);
    }
    @Query(() => membershipResourceReview_, { nullable: true })
    async membershipResourceReview(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<membershipResourceReview_ | null> {
        this.CheckUserReadPermissions('Resource Reviews', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('membership', 'vwResourceReviews')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resource Reviews', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.MapFieldNamesToCodeNames('Resource Reviews', rows && rows.length > 0 ? rows[0] : null, this.GetUserFromPayload(userPayload));
        return result;
    }
    
    @Mutation(() => membershipResourceReview_)
    async CreatemembershipResourceReview(
        @Arg('input', () => CreatemembershipResourceReviewInput) input: CreatemembershipResourceReviewInput,
        @Ctx() { providers, userPayload }: AppContext,
        @PubSub() pubSub: PubSubEngine
    ) {
        const provider = GetReadWriteProvider(providers);
        return this.CreateRecord('Resource Reviews', input, provider, userPayload, pubSub)
    }
        
    @Mutation(() => membershipResourceReview_)
    async UpdatemembershipResourceReview(
        @Arg('input', () => UpdatemembershipResourceReviewInput) input: UpdatemembershipResourceReviewInput,
        @Ctx() { providers, userPayload }: AppContext,
        @PubSub() pubSub: PubSubEngine
    ) {
        const provider = GetReadWriteProvider(providers);
        return this.UpdateRecord('Resource Reviews', input, provider, userPayload, pubSub);
    }
    
    @Mutation(() => membershipResourceReview_)
    async DeletemembershipResourceReview(@Arg('ID', () => String) ID: string, @Arg('options___', () => DeleteOptionsInput) options: DeleteOptionsInput, @Ctx() { providers, userPayload }: AppContext, @PubSub() pubSub: PubSubEngine) {
        const provider = GetReadWriteProvider(providers);
        const key = new CompositeKey([{FieldName: 'ID', Value: ID}]);
        return this.DeleteRecord('Resource Reviews', key, options, provider, userPayload, pubSub);
    }
...
export class AssociationDemoResourceTagResolver extends ResolverBase {
    ...
    async AssociationDemoResourceTag(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoResourceTag_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResourceTags')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resource Tags', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoResourceVersionResolver extends ResolverBase {
    ...
    async AssociationDemoResourceVersion(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoResourceVersion_ | null> {
        this.CheckUserReadPermissions('Resource Versions', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResourceVersions')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resource Versions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
...
export class AssociationDemoResourceResolver extends ResolverBase {
    ...
    async AssociationDemoResource(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoResource_ | null> {
        this.CheckUserReadPermissions('Resources', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResources')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resources', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoResourceVersions_ResourceIDArray(@Root() associationdemoresource_: AssociationDemoResource_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Resource Versions', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResourceVersions')} WHERE ${provider.QuoteIdentifier('ResourceID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resource Versions', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoresource_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Resource Versions', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoResourceRatings_ResourceIDArray(@Root() associationdemoresource_: AssociationDemoResource_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Resource Ratings', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResourceRatings')} WHERE ${provider.QuoteIdentifier('ResourceID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resource Ratings', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoresource_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Resource Ratings', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
    ...
    async AssociationDemoResourceTags_ResourceIDArray(@Root() associationdemoresource_: AssociationDemoResource_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Resource Tags', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResourceTags')} WHERE ${provider.QuoteIdentifier('ResourceID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resource Tags', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoresource_.ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoResourceDownloads_ResourceIDArray(@Root() associationdemoresource_: AssociationDemoResource_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Resource Downloads', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwResourceDownloads')} WHERE ${provider.QuoteIdentifier('ResourceID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Resource Downloads', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemoresource_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Resource Downloads', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
...
export class AssociationDemoSegmentResolver extends ResolverBase {
    ...
    async AssociationDemoSegment(@Arg('ID', () => String) ID: string, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine): Promise<AssociationDemoSegment_ | null> {
        ...
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwSegments')} WHERE ${provider.QuoteIdentifier('ID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Segments', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [ID], undefined, this.GetUserFromPayload(userPayload));
    ...
    async AssociationDemoCampaignMembers_SegmentIDArray(@Root() associationdemosegment_: AssociationDemoSegment_, @Ctx() { userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Campaign Members', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const sSQL = `SELECT * FROM ${provider.QuoteSchemaAndView('AssociationDemo', 'vwCampaignMembers')} WHERE ${provider.QuoteIdentifier('SegmentID')}=${provider.BuildParameterPlaceholder(0)} ` + this.getRowLevelSecurityWhereClause(provider, 'Campaign Members', userPayload, EntityPermissionType.Read, 'AND');
        const rows = await provider.ExecuteSQL(sSQL, [associationdemosegment_.ID], undefined, this.GetUserFromPayload(userPayload));
        const result = await this.ArrayMapFieldNamesToCodeNames('Campaign Members', rows, this.GetUserFromPayload(userPayload));
        return result;
    }
